...
function GetDetails(id) {
    $.ajax({
        url: "/PosStatusSimTable/GetDetail/" + id,
        typr: "GET",
...
$(document).ready(function () {
    ...
    var table = $('#mainTable').DataTable({
        ...
        ajax: '/PosStatusSimTable/GetAllRows',
        "autoWidth": false,
        "columnDefs": [
        {
            "searchable": false,
    ...
    $('#mainForm').on('submit', function (event) {
        ...
        var _url = '';
        if ($('#mainModal').data('mode') == 'create') {
            _url = 'PosStatusSimTable/Create'
        } else {
            _url = 'PosStatusSimTable/Update'
        }
        if ($('#mainForm').valid()) {
            $.ajax({
                url: _url,
    ...
    $('#upload').on('click', function () {
        ...
        $.ajax({
            url: 'PosStatusSimTable/UploadFile',
