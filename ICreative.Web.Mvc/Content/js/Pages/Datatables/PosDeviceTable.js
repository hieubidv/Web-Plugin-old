...
function GetDetails(id) {
    $.ajax({
        url: "/PosDeviceTable/GetDetail/" + id,
        typr: "GET",
...
$(document).ready(function () {
    ...
    var table = $('#mainTable').DataTable({
        ...
        ajax: '/PosDeviceTable/GetAllRows',
        "autoWidth": false,
        "columnDefs": [
        {
            "searchable": false,
    ...
    $('#mainForm').on('submit', function (event) {
        ...
        var _url = '';
        if ($('#mainModal').data('mode') == 'create') {
            _url = 'PosDeviceTable/Create'
        } else {
            _url = 'PosDeviceTable/Update'
        }
        if ($('#mainForm').valid()) {
            $.ajax({
                url: _url,
