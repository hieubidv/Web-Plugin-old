...
function GetDetails(id) {
    $.ajax({
        url: "/PosAddressTable/GetDetail/" + id,
        typr: "GET",
...
$(document).ready(function () {
    ...
    var table = $('#mainTable').DataTable({
        ...
        ajax: '/PosAddressTable/GetAllRows',
        "autoWidth": false,
        "columnDefs": [
        {
            "searchable": false,
    ...
    $('#mainForm').on('submit', function (event) {
        ...
        var _url = '';
        if ($('#mainModal').data('mode') == 'create') {
            _url = 'PosAddressTable/Create'
        } else {
            _url = 'PosAddressTable/Update'
        }
        if ($('#mainForm').valid()) {
            $.ajax({
                url: _url,
    ...
    $('#upload').on('click', function () {
        ...
        $.ajax({
            url: 'PosAddressTable/UploadFile',
