...
function GetDetails(id) {
    $.ajax({
        url: "/CustomerTable/GetDetail/" + id,
        typr: "GET",
        ...
        success: function (response) {
            ...
            $('#ContactTitle').val(response.ContactTitle);
...
$(document).ready(function () {
    ...
    $('#mainForm').on('submit', function (event) {
        ...
        var _url = '';
        if ($('#mainModal').data('mode') == 'create') {
            _url = 'CustomerTable/Create'
        } else {
            _url = 'CustomerTable/Update'
        }
        if ($('#mainForm').valid()) {
            $.ajax({
                url: _url,
