...
function GetDetails(id) {
    $.ajax({
        url: "/CategoryTable/GetDetail/" + id,
        typr: "GET",
...
$(document).ready(function () {
    ...
    $('#mainForm').on('submit', function (event) {
        ...
        var _url = '';
        if ($('#mainModal').data('mode') == 'create') {
            _url = 'CategoryTable/Create'
        } else {
            _url = 'CategoryTable/Update'
        }
        if ($('#mainForm').valid()) {
            $.ajax({
                url: _url,
