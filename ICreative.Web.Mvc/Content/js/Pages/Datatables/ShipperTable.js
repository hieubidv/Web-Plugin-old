...
$(document).ready(function () {
    ...
    $('#mainForm').on('submit', function (event) {
        ...
        var _url = '';
        if ($('#mainModal').data('mode') == 'create') {
            _url = 'ShipperTable/Create'
        } else {
            _url = 'ShipperTable/Update'
        }
        if ($('#mainForm').valid()) {
            $.ajax({
                url: _url,
