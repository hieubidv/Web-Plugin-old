...
namespace ICreative.Model
{
    ...
    {
          public static readonly BusinessRule SupplierIDRequired = new BusinessRule(
                                      "SupplierID", "Trường Mã nhà cung cấp không được để trống");                        
          ...
          public static readonly BusinessRule HomePageRequired = new BusinessRule(
                                      "HomePage", "Trường Trang chủ không được để trống");                        
    }   
}
