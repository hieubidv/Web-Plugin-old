...
{
  public class WebPagerItem
  {
    #region Constructors
    public WebPagerItem(int pageCount, int pageIndex, string tooltip)
    {
      Init();
    ...
    public WebPagerItem(string text, string arg, bool disabled, string tooltip)
    {
      Init();
